...
<body>
	<div class="row">
		<div class="page-header">
			<h1 style="margin-left: 20px;">
				<spring:message code="listProduct.form.title.label" />
			</h1>
			<a href="?locale=en">English</a>| <a href="?locale=jp">Japanese</a>
		</div>
	</div>
	...
	<c:forEach var="type" items="${users}">
		<div class="col-sm-4">
			<div class="thumbnail">${type.value.username}
				${type.value.address} ${type.value.sex} ${type.value.birthdate}
				
				<a class="btn btn-danger" href="deleteUser/${type.value.username}">Delete</a>
				<a class="btn btn-warning" href="editUser/${type.value.username}">Edit</a>
			</div>
		</div>
	</c:forEach>
</body>
